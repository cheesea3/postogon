<?php
//creates a new pdo object, mysql: tells pdo the type of database to user_error
//then we tell pdo where we're hosting the database.
//then we tell pdo which database
//then we tell pdo which charset, we use utf8
//then we tell pdo which username
//then we tell pdo which password
$pdo = new PDO('mysql:host=127.0.0.1;dbname=postogon;charset=utf8', 'root', '');
//pdo error reporting. 
